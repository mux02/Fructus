...
let fruitsData: [Fruit] = [
    Fruit(
        title: "التوت",
        headline: "التوت الأزرق فاكهة حلوة ومغذية وذات شعبية كبيرة في جميع أنحاء العالم.",
        image: "blueberry",
        gradientColors: [Color("ColorBlueberryLight"), Color("ColorBlueberryDark")],
        description: """
          العنب البري نباتات مزهرة معمرة مع التوت الأزرق أو الأرجواني. يتم تصنيفها في القسم Cyanococcus ضمن جنس Vaccinium. يشمل Vaccinium أيضًا التوت البري والتوت البري والتوت البري وتوت ماديرا.

                    توت العنب البري التجاري - البري (الشجيرات المنخفضة) والمزروعة (المرتفعات) - كلها موطنها أمريكا الشمالية. تم إدخال أصناف highbush إلى أوروبا خلال الثلاثينيات.

                    عادة ما يكون العنب البري عبارة عن شجيرات سجودة يمكن أن تختلف في الحجم من 10 سم (3.9 بوصة) إلى 4 أمتار (13 قدمًا) في الارتفاع. في الإنتاج التجاري للعنب البري ، تُعرف الأنواع التي تحتوي على توت صغير بحجم حبة البازلاء التي تنمو على شجيرات منخفضة المستوى باسم "توت لو بوش" (مرادف لكلمة "بري") ، بينما تُعرف الأنواع التي تحتوي على توت أكبر ينمو على شجيرات مزروعة أطول باسم "توت هايبوش".

                    كندا هي المنتج الرئيسي للتوت الأزرق ، بينما تنتج الولايات المتحدة حوالي 40 ٪ من الإمداد العالمي من التوت الأزرق.

                    الاستخدامات

                    يُباع العنب البري طازجًا أو تتم معالجته كفاكهة مجمدة بسرعة فردية (IQF) ، أو مهروس ، أو عصير ، أو التوت المجفف أو المنقوع. يمكن بعد ذلك استخدامها في مجموعة متنوعة من السلع الاستهلاكية ، مثل الجيلي والمربى وفطائر التوت البري والكعك والأطعمة الخفيفة ، أو كمضافات لحبوب الإفطار.

                    يتكون مربى العنب البري من العنب البري والسكر والماء وبكتين الفاكهة. صلصة التوت الأزرق هي صلصة حلوة محضرة باستخدام العنب البري كمكون أساسي.

                    نبيذ العنب البري مصنوع من لحم وجلد التوت الذي يتم تخميره ثم نضجه ؛ عادة ما يتم استخدام صنف lowbush.

                    العناصر الغذائية

                    تتكون العنب البري من 14٪ كربوهيدرات و 0.7٪ بروتين و 0.3٪ دهون و 84٪ ماء (مائدة). أنها تحتوي فقط على كميات ضئيلة من المغذيات الدقيقة ، مع مستويات معتدلة (بالنسبة للقيم اليومية ذات الصلة) (DV) من المنغنيز المعدني الغذائي الأساسي وفيتامين ج وفيتامين ك والألياف الغذائية (الجدول).

                    بشكل عام ، محتويات المغذيات في العنب البري هي نسبة منخفضة من DV (الجدول). توفر الحصة الواحدة قيمة سعرات حرارية منخفضة نسبيًا تبلغ 57 كيلو كالوري مع تحميل نسبة السكر في الدم 6.
          """,
